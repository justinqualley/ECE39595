...
int main(int argc, char** args) {
   ...
   Address& add1ref= add1;
   Address& add2ref= add2;
   
   Employee emp1 = Employee(std::string("Jerry Jeff Walker"), 3, 16, 1942, add1ref, 55000);
   Employee emp2 = Employee(std::string("Fran Allen"), 8, 4, 1932, add2ref, 256000);
